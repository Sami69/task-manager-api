...
const sendWelcomeEmail = (email, name) => {
    sgMail.send({
        ...
        text: `Welcome to audio infinity, ${name}. We would love to have you optinion and inpts on your experience with us. We wish you a great exprience with our products.`
    })
}
